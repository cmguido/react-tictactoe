Make sure you have everything installed to run React first, then:
### Run from local host 3000 by entering 'npm start' into terminal ###
  ## If there are issues, run 'npm build' first, then repeat first step ##


<img src="reactttt.png" alt="Tic Tac Toe Board"></img>
